...
use BackSystem\Base\Fixer\EmptyBracesFixer;
...
return $config->setUsingCache(false)
    ->registerCustomFixers([new BlankLineAroundClassBodyFixer(), new EmptyBracesFixer(), new OneAttributePerLineFixer()])
    ->setRules([
        '@Symfony' => true,
